...
/* NRF24L01引脚 */
#define NRF_SPI_CE_PIN     GPIO_Pin_1
#define NRF_SPI_CE_PORT    GPIOA
#define NRF_SPI_CE_CLK     RCC_APB2Periph_GPIOA

#define NRF_SPI_IRQ_PIN    GPIO_Pin_0
#define NRF_SPI_IRQ_PORT   GPIOA
#define NRF_SPI_IRQ_CLK    RCC_APB2Periph_GPIOA

#define NRF_SPI_CSN_PIN    GPIO_Pin_4
#define NRF_SPI_CSN_PORT   GPIOA
#define NRF_SPI_CSN_CLK    RCC_APB2Periph_GPIOA

#define NRF_SPI_SCK_PIN     GPIO_Pin_5
#define NRF_SPI_MISO_PIN    GPIO_Pin_6
#define NRF_SPI_MOSI_PIN    GPIO_Pin_7
#define NRF_SPI1_GPIO_PORT  GPIOA
#define NRF_SPI1_GPIO_CLK   RCC_APB2Periph_GPIOA
